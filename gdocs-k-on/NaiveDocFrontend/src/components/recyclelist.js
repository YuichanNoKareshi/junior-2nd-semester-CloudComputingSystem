...
class RecycleList extends React.Component {
    ...
    renderList = () => {
        ...
        for (let i = 0; i < this.state.roomlist.length; i++) {
            result.push(<RSTR info={this.state.roomlist[i]} />)
...
export  default withRouter(RecycleList);